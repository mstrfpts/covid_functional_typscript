import { updateHistoricalDataDailyCount } from "../store/actions";
...
export const getDailyCount = (
  ...
  if (Object.keys(countrySelectedHistoricalData).length) {
    ...
    dispatch(updateHistoricalDataDailyCount(historicalDataDailyCount));
  }
};
